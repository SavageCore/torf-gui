...
class Ui_MainWindow:
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.randomizeInfoHashCheckBox, 9, 0, 1, 1)
        ...
        self.menuMediainfo = QtWidgets.QMenu(self.menuSettings)
        self.menuMediainfo.setObjectName("menuMediainfo")
        ...
        self.actionToggleMediainfo = QtWidgets.QAction(MainWindow)
        self.actionToggleMediainfo.setCheckable(True)
        self.actionToggleMediainfo.setObjectName("actionToggleMediainfo")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.batchModeCheckBox.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>If enabled, a torrent will be created for each directory and file one level below the input directory. The piece size for each torrent will be determined automatically.</p></body></html>",
            )
        )
        ...
        self.md5CheckBox.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>This is not used by BitTorrent at all, but it is included by some programs for greater compatibility.</p></body></html>",
            )
        )
        ...
        self.privateTorrentCheckBox.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>If enabled, clients will not use DHT or Peer Exchange to discover peers or transfer data. Make sure to enable this option for private trackers.</p></body></html>",
            )
        )
        ...
        self.sourceEdit.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>An optional source string that wil be added to the info dictionary. Useful for creating torrents with unique info hashes for private trackers.</p></body></html>",
            )
        )
        ...
        self.randomizeInfoHashCheckBox.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>If enabled, this adds an entropy field to the info section of the metainfo and sets it to a random integer, to help with cross-seeding.</p></body></html>",
            )
        )
        self.randomizeInfoHashCheckBox.setText(
            _translate("MainWindow", "Randomise info hash")
        )
        ...
        self.menuMediainfo.setTitle(_translate("MainWindow", "Mediainfo"))
        ...
        self.actionToggleMediainfo.setText(_translate("MainWindow", "Enable"))

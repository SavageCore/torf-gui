...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetCont = QtWidgets.QWidget()
        self.scrollAreaWidgetCont.setGeometry(QtCore.QRect(0, 0, 459, 818))
        self.scrollAreaWidgetCont.setObjectName("scrollAreaWidgetCont")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.scrollAreaWidgetCont)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.widget = QtWidgets.QWidget(self.scrollAreaWidgetCont)
        self.widget.setObjectName("widget")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.inputGroupBox = QtWidgets.QGroupBox(self.widget)
        ...
        self.verticalLayout_9.addWidget(self.inputGroupBox)
        self.seedingGroupBox = QtWidgets.QGroupBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.randomizeInfoHashCheckBox = QtWidgets.QCheckBox(self.optionGroupBox)
        self.randomizeInfoHashCheckBox.setObjectName("randomizeInfoHashCheckBox")
        ...
        self.verticalLayout_9.addWidget(self.seedingGroupBox)
        self.verticalLayout_6.addWidget(self.widget)
        self.scrollArea.setWidget(self.scrollAreaWidgetCont)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.excludeLabel.setText(_translate("MainWindow", "Filename exclusion patterns (globs, one per line)"))
        ...
        self.randomizeInfoHashCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>If enabled, this adds an entropy field to the info section of the metainfo and sets it to a random integer, to help with cross-seeding.</p></body></html>"))
        self.randomizeInfoHashCheckBox.setText(_translate("MainWindow", "Randomise info hash"))
